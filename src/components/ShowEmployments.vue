<template>
  <el-table :data="filterTableData" style="width: 100%">
    <el-table-column label="员工Id" prop="eid" />
    <el-table-column label="员工姓名" prop="ename" />
    <el-table-column label="员工年龄" prop="eage" />
    <el-table-column label="员工卡号" prop="idcard" />
    <el-table-column label="员工联系方式" prop="eaddr" />
  ...
  <el-dialog v-model="dialogFormVisible" title="请输入您想要添加的数据" >
    <el-form :model="form" >
      ...
      <el-form-item label="员工联系方式" :label-width="formLabelWidth">
